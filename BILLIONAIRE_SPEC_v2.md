...
### Guided Learning Depth
- The Learn section must support a guided 30-day investing curriculum, not only short static concept cards.
- The curriculum should be appropriate for a 12-year-old beginner but become gradually harder over the month.
- The learning path should teach Buffett-style investing process:
  - Stocks are ownership in businesses.
  - Understand how a company makes money.
  - Stay inside the player's circle of competence.
  - Study moats and durable competitive advantages.
  - Compare price with value.
  - Use margin of safety.
  - Understand debt, earnings quality, management, and opportunity cost.
  - Review portfolio risk and position sizing.
  - Practice patience and written investment memos.
- The path should end with capstone activities:
  - A full stock memo.
...
- Concept progress should be markable from obvious buttons, from BILL-led lesson/quiz actions, and from plain-language BILL requests such as “mark my concepts.”
